...
export default function Home() {
	...
	const birthDate = new Date(2004, 2, 9)
			...
			<div className={styles.animated}>
				...
				<div className={styles.hello}>
					...
					<p style={{margin: ".3rem 0"}}>
						Я - <b>Сергей</b>, <span title="9 Марта 2004г.">{age} лет</span><br/>
						Програмист-любитель, если кратко.
					</p>
					<p>
				...
				<div className={styles.social}>
					<a href="https://github.com/shaehl" style={{color: "#eeeeee", textDecoration: "none"}} target="_blank">
